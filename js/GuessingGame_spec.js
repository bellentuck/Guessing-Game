...
describe("Game class", function() {
    ...
    describe("Objects (category for things like constants and state) on the Game Constructor Function's `.prototype`", function() {
       describe('The `playerMessages` object literal', function() {
           it('Holds default messages for 7 outcomes', function() {
               expect(Object.keys(game.playerMessages).length).toEqual(7);
           });
           it('Holds win-specific message', function() {
               expect(game.playerMessages.hasOwnProperty('win')).toBe(true);
           });
           it('Holds loss-specific message', function() {
            expect(game.playerMessages.hasOwnProperty('lose')).toBe(true);
        });
       });
    });
...
describe('jQuery specs', function() {
    describe('the `processPlayerGuess` function', function() {
        it('operates on a game instance', function() {});
        it('takes in a value from `#player-input`', function() {});
        it('resets the value of `#player-input` to an empty string', function() {});
        it('computes guess outcome using `game`\'s `prototype`\'s `playersGuessSubmission` method', function() {});
        it('sends `outcome` on to `processGuessOutcome` along with the game instance', function() {});
    });
    describe('the `processGuessOutcome` function', function() {
...
// , create a new game instance. Reset the #title and #subtitle, and .guess list elements to their default values. You'll also need to make sure that your #submit and #hint buttons aren't disabled.
...
describe('game reset', function() {
    it('creates a new game instance when the \'reset\' button is pressed', function() {
